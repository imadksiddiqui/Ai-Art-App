  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
            ...
            <p className="mt-2 text-[#666e75] text-16px] max-w[500px]">Generate stunning art through the DALL-E AI</p>
        </div>

        <form className='mt-16 max-w-3xl' onSumbmit={handleSubmit}>
            ...
            <div className='mt-10'>
              <p className='mt-2 text-[#666e75] text-[14px]'>Share the image with the community! </p>
